...
void retiraDoTimeout(short seq, unsigned long *listaTime[SEQ_MAX], char mensagens[SEQ_MAX][MSG_SIZE]){
	*listaTime[seq] = 0;
...
void checaTimeouts(unsigned long *listaTime[SEQ_MAX], char mensagens[SEQ_MAX][MSG_SIZE], int soquete){
